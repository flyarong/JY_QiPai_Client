...
public class MiitHelper implements IIdentifierListener {
    ...
    public static final int HELPER_VERSION_CODE = 20211214; // MiitHelper的版本号 跟SDK版本同步
    ...
    public static final String ASSET_FILE_NAME_CERT = "com.jingyu.rrddz.cert.pem";  // [2]设置 鲸鱼斗地主asset证书文件名

    public MiitHelper(){
        System.loadLibrary("msaoaidsec");  // [3]加固版本在调用前必须载入SDK安全库
