...
class ChannelProcessBuilderWQPDDZ_PDD : IPreprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPreprocessBuild(BuildTarget buildTarget, string path) {
		string channelName = AppDefine.CurQuDao;
		if (string.Compare (channelName, "wqpddz_pdd", true) != 0)
			return;

		UnityEngine.Debug.Log ("OnPreprocessBuild for wqpddz_pdd channel!");
...
class PostProcessBuilderWQPDDZ_PDD : IPostprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPostprocessBuild(BuildTarget buildTarget, string path) {
		...
		UnityEngine.Debug.Log ("OnPostprocessBuild for wqpddz_pdd channel!");
