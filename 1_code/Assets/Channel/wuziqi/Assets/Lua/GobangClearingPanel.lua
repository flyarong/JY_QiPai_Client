...
function C:ctor()
	...
	self.Ready_btn.gameObject.transform:GetComponent("Image").sprite = GetTexture("settlement_btn_next_game_gobang")
	self.Changedesk_btn.gameObject.transform:GetComponent("Image").sprite = GetTexture("com_btn_huanzhuo_game_gobang")
