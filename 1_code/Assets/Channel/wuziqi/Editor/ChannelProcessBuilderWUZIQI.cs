...
class ChannelProcessBuilderWUZIQI : IPreprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPreprocessBuild(BuildTarget buildTarget, string path) {
		string channelName = AppDefine.CurQuDao;
		if (string.Compare (channelName, "wuziqi", true) != 0)
			return;

		UnityEngine.Debug.Log ("OnPreprocessBuild for wuziqi channel!");

#if UNITY_IOS
		PlayerSettings.applicationIdentifier = "com.kashibuyi.wzq";
#else
...
class PostProcessBuilderWUZIQI : IPostprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPostprocessBuild(BuildTarget buildTarget, string path) {
		...
		UnityEngine.Debug.Log ("OnPostprocessBuild for wuziqi channel!");
