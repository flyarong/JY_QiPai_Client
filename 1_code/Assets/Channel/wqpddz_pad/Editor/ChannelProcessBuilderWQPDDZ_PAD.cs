...
class ChannelProcessBuilderWQPDDZ_PAD : IPreprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPreprocessBuild(BuildTarget buildTarget, string path) {
		string channelName = AppDefine.CurQuDao;
		if (string.Compare (channelName, "wqpddz_pad", true) != 0)
			return;

		UnityEngine.Debug.Log ("OnPreprocessBuild for wqpddz_pad channel!");
...
class PostProcessBuilderWQPDDZ_PAD : IPostprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPostprocessBuild(BuildTarget buildTarget, string path) {
		...
		UnityEngine.Debug.Log ("OnPostprocessBuild for wqpddz_pad channel!");
