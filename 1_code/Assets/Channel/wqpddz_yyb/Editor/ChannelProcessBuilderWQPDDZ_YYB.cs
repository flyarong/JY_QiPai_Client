...
class ChannelProcessBuilderWQPDDZ_YYB : IPreprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPreprocessBuild(BuildTarget buildTarget, string path) {
		string channelName = AppDefine.CurQuDao;
		if (string.Compare (channelName, "wqpddz_yyb", true) != 0)
			return;

		UnityEngine.Debug.Log ("OnPreprocessBuild for wqpddz_yyb channel!");

		PlayerSettings.applicationIdentifier = "com.tencent.tmgp.wanqpddz";
...
class PostProcessBuilderWQPDDZ_YYB : IPostprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPostprocessBuild(BuildTarget buildTarget, string path) {
		...
		UnityEngine.Debug.Log ("OnPostprocessBuild for wqpddz_yyb channel!");
