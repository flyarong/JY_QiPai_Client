...
local Button_DataS = {
	[1] = {name = "VIP特权",goto_ui = "viptq",},
	[2] = {name = "VIP礼包",goto_ui = "viplb"},
	[3] = {name = "VIP每周福利",goto_ui = "vipmzfl"},
	[4] = {name = "VIP4回馈赛",goto_ui = "vipmxb"},
	[5] = {name = "赢金挑战",goto_ui = "vipyjtz"},
	[6] = {name = "福利赛挑战",goto_ui = "vipqys"},
}

local Panel_DataS = {
	[1] = {name = "VipShowTQPanel",goto_ui = "viptq"},
	[2] = {name = "VipShowLBPanel",goto_ui = "viplb"},
	[3] = {name = "VipShowMZFLPanel",goto_ui = "vipmzfl"},
	[4] = {name = "VipShowMXBPanel",goto_ui = "vipmxb"},
	[5] = {name = "VipShowYJTZPanel",goto_ui = "vipyjtz"},
	[6] = {name = "VipShowQYSPanel",goto_ui = "vipqys"},
}
local Buttons_UI
local Panels
...
function C:InitUI()
	...
	self:MyRefresh()
	--ios提审屏蔽
	Buttons_UI[Button_DataS[3].name].gameObject:SetActive(false)
	Buttons_UI[Button_DataS[4].name].gameObject:SetActive(false)
	Buttons_UI[Button_DataS[6].name].gameObject:SetActive(false)
end
