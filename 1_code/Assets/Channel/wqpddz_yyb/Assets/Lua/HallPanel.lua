...
function HallPanel:SetupBtns()
	...
	self.FKBox.PointerClick:AddListener(function (obj)
		GameManager.GotoUI({gotoui="free_hall", goto_scene_parm={game_type = "game_Gobang"}})
	end)
...
function HallPanel:ctor(call)
	...
	self.email_btn.gameObject:SetActive(false)
	...
	self.VIP_btn.gameObject:SetActive(GameGlobalOnOff.Vip)
	self.head_vip_txt.gameObject:SetActive(GameGlobalOnOff.Vip)
