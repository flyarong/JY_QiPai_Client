...
class PreProcessBuilderCaiYunMJ_HW_main : IPreprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPreprocessBuild(BuildTarget buildTarget, string path) {
		string channelName = AppDefine.CurQuDao;
		if (string.Compare (channelName, "caiyunmj_hw_main", true) != 0)
			return;

		UnityEngine.Debug.Log ("OnPreprocessBuild for caiyunmj_hw_main channel!");
...
class PostProcessBuilderCaiYunMJ_HW_main : IPostprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPostprocessBuild(BuildTarget buildTarget, string path) {
		...
		UnityEngine.Debug.Log ("OnPostprocessBuild for caiyunmj_hw_main channel!");
