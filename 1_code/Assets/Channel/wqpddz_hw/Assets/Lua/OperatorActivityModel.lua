...
if AppDefine.IsEDITOR() then
    free_activity_one_config = require "Game.CommonPrefab.Lua.free_activity_one_config"
    operator_activity_one_config = require "Game.CommonPrefab.Lua.operator_activity_one_config"
    free_activity_two_config = require "Game.CommonPrefab.Lua.free_activity_two_config"
    operator_activity_two_config = require "Game.CommonPrefab.Lua.operator_activity_two_config"
else
    if GameGlobalOnOff.IOSTS then
    	free_activity_one_config = require "Game.CommonPrefab.Lua.IOSTS_free_activity_one_config"
        free_activity_two_config = require "Game.CommonPrefab.Lua.IOSTS_free_activity_two_config"
		operator_activity_one_config = require "Game.CommonPrefab.Lua.IOSTS_operator_activity_one_config"
		operator_activity_two_config = require "Game.CommonPrefab.Lua.IOSTS_operator_activity_two_config"
    else
