...
class ChannelProcessBuilderWQPDDZ_HW_MAIN : IPreprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPreprocessBuild(BuildTarget buildTarget, string path) {
		string channelName = AppDefine.CurQuDao;
		if (string.Compare (channelName, "wqpddz_hw_main", true) != 0)
			return;

		UnityEngine.Debug.Log ("OnPreprocessBuild for wqpddz_hw_main channel!");
...
class PostProcessBuilderWQPDDZ_HW_MAIN : IPostprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPostprocessBuild(BuildTarget buildTarget, string path) {
		...
		UnityEngine.Debug.Log ("OnPostprocessBuild for wqpddz_hw_main channel!");
