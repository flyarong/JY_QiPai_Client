...
class PreProcessBuilderCaiYunMJ_Trial : IPreprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPreprocessBuild(BuildTarget buildTarget, string path) {
		string channelName = AppDefine.CurQuDao;
		if (string.Compare (channelName, "caiyunmj_trial", true) != 0)
			return;

		UnityEngine.Debug.Log ("OnPreprocessBuild for caiyunmj_trial channel!");
...
class PostProcessBuilderCaiYunMJ_Trial : IPostprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPostprocessBuild(BuildTarget buildTarget, string path) {
		...
		UnityEngine.Debug.Log ("OnPostprocessBuild for caiyunmj_trial channel!");
