...
class PreProcessBuilderDDZ_AIBIANXIAN : IPreprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPreprocessBuild(BuildTarget buildTarget, string path) {
		string channelName = AppDefine.CurQuDao;
		if (string.Compare (channelName, "aibianxian", true) != 0)
			return;

		UnityEngine.Debug.Log ("OnPreprocessBuild for aibianxian channel!");
...
class PostProcessBuilderDDZ_AIBIANXIAN : IPostprocessBuild {
	public int callbackOrder { get { return 0; } }
	public void OnPostprocessBuild(BuildTarget buildTarget, string path) {
		...
		UnityEngine.Debug.Log ("OnPostprocessBuild for aibianxian channel!");
