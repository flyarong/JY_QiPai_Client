...
function C:ctor(parent, data, is_game_create)
	...
	if self.fish_cfg.id == 27 then
		...
		parm.fish_anim = "node"
	elseif self.fish_cfg.id == 60 then
		parm.fish_list = {"fish","fish/zp", "fish/jb_icon", "fish/x", 
		"fish/num_node/num_content/num", 
		"fish/num_node/num_content/num (1)", 
		"fish/num_node/num_content/num (2)", 
		"fish/num_node/num_content/num (3)", 
		"fish/num_node/num_content/num (4)", 
		"fish/num_node/num_content/num (5)", 
		"fish/num_node/num_content/num (6)", 
		"fish/num_node/num_content/num (7)", 
		"fish/num_node/num_content/num (8)", 
		"fish/num_node/num_content/num (9)", 
		"fish/num_node/num_content/num (10)", 
		"fish/hand_up", "fish/hand_down", "fish/bell", "fish/tie"}
		parm.fish_tran = "fish"
	...
	--鱼没有创建成功
	if not self.fish_base.prefab then self:MyExit() end
	self.parm = parm
