...
function MjXlClearing:CalcMyResult(data)
	...
	if MjXlModel.GetRealPlayerSeat () == seatno then
		...
		local a,b = GameButtonManager.RunFun({gotoui="sys_act_operator",game_id = MjXlModel.data.game_id}, "CheckShowLS")
		local is_show_ls = a and b
		if isWin and MjXlModel.data.ls_count > 1 and is_show_ls then
