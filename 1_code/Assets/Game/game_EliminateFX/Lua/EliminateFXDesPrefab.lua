...
EliminateFXDesPrefab=basefunc.class()
local M=EliminateFXDesPrefab
local  ins
M.name="EliminateFXDesPrefab"
M.des_id=""
M.des_num=""
M._isReCreat=""
...
function M:ctor(parent)
    ...
    local img=tran:Find("GameObject/IconImage"):GetComponent("Image")
    img.sprite= EliminateFXObjManager.item_obj["xxl_icon_" .. self.des_id]
    t.text=self.des_num
...
function M:MyExit()
	...
	local img=self.transform:Find("GameObject/IconImage"):GetComponent("Image")
	img.sprite = nil
