...
function DdzDzCard:Destroy()
    GameObject.Destroy(self.gameObject)
    self = nil
end

--设置牌面
function DdzDzCard:SetCard()
    ...
    elseif self.no >= 60  then
    	print("DdzDzCard:SetCard Laizi: " .. self.no)
