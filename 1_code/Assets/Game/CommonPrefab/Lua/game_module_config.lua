return {
	config=
	{
		...
		{
			id = 413,
			key = "sys_act_base_style/sys_act_base_044_weekly",
			desc = "狂欢庆典",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 416,
			key = "act_ty_by_drop_style/act_037_juhua",
			desc = "蛋糕鱼BOSS",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 428,
			key = "act_ty_gifts_style/act_043_fqlb",
			desc = "庆典礼包",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 433,
			key = "act_ty_exchange_style/act_032_qfdh",
			desc = "好礼兑换",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 434,
			key = "act_ty_rank_style/act_046_fqbd",
			desc = "招财榜单",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 441,
			key = "act_057_ios_wqpxw2abx",
			desc = "玩棋牌闲玩ios转爱变现",
			lua = "Act_057_WQPXW2ABXManager",
			is_on_off = 0,
			enable = 1,
			state = 1,
		},
		...
		{
			id = 442,
			key = "sys_ydjf_exchange",
			desc = "移动积分兑换",
			lua = "SysYdJfExchangeManager",
			is_on_off = 1,
			enable = 1,
			state = 1,
		},
		...
		{
			id = 445,
			key = "act_059_dwjj_jrlb",
			desc = "节日礼包",
			lua = "Act_059_DwJrlbManager",
			is_on_off = 1,
			enable = 1,
			state = 1,
		},
		...
		{
			id = 447,
			key = "act_061_czjccard",
			desc = "充值加成卡",
			lua = "Act_061_CZJCCardManager",
			is_on_off = 1,
			enable = 1,
			state = 1,
		},
		...
		{
			id = 460,
			key = "act_ty_rank_style/act_034_zqbd",
			desc = "庆典榜单",
			is_on_off = 0,
			enable = 0,
			state = 0,
