...
function MjXzModel.on_fg_activity_data_msg(proto_name, data)
    ...
    if m_data and m_data.activity_data then
        ...
        if m_ad.activity_id == ActivityType.TianJiangCaiShen then
            ...
            Event.Brocast("activity_fg_activity_data_msg",{activity_data = m_data.activity_data,game_type = MjXzModel.game_type,game_id = MjXzModel.baseData.game_id,model_status = m_data.model_status,status = m_data.status})
        end
    end
end
...
function MjXzModel.AssetChange(proto_name, data)
    ...
    if m_data.playerInfo and m_data.playerInfo[m_data.seat_num] and  m_data.playerInfo[m_data.seat_num].base then
        m_data.playerInfo[m_data.seat_num].base.score = data.score
    end
