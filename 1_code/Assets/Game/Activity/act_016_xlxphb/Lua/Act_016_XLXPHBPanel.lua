...
Act_016_XLXPHBPanel = basefunc.class()
local C = Act_016_XLXPHBPanel
C.name = "Act_016_XLXPHBPanel"
...
local curr_index = 1
local DESCRIBE_TEXT = {
	[1] = "1.活动时间：6月16日7:30-6月22日18:00:00",
	[2] = "2.活动期间街机捕鱼游戏中会出现龙虾券BOSS鱼，部分鱼身上会附加龙虾兑换券，击杀可参与排行榜",
