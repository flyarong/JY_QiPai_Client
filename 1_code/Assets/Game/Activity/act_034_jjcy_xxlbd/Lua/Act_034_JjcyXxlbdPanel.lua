...
Act_034_JjcyXxlbdPanel = basefunc.class()
local C = Act_034_JjcyXxlbdPanel
C.name = "Act_034_JjcyXxlbdPanel"
...
local DESCRIBE_TEXT = {
    [1] = "1.活动时间：10月20日7:30~10月26日23:59:59",
...
function C:on_act_015_xxlbd_base_info_get(_, data)
    -- body
end
