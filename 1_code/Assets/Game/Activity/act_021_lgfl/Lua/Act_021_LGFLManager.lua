...
local task_ids = {
    [1] = {21402,21403,21404,21405,},
    [2] = {21397,21398,21399,21400,21401}
}
local year_ids = {
    104,103
}
local permission = {
    "actp_own_task_p_021_v1_present",
    "actp_own_task_p_021_v4_present",
}
