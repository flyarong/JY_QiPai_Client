...
Act_015_XXLBDPanel = basefunc.class()
local C = Act_015_XXLBDPanel
C.name = "Act_015_XXLBDPanel"
local M = Act_015_XXLBDManager
local HGList={
	[1] ="localpop_icon_1",
	[2] ="localpop_icon_2",
	[3] ="localpop_icon_3",
