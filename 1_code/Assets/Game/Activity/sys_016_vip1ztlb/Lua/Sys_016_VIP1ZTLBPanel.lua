...
Sys_016_VIP1ZTLBPanel = basefunc.class()
local C = Sys_016_VIP1ZTLBPanel
C.name = "Sys_016_VIP1ZTLBPanel"
...
function C:InitUI()
    PointerEventListener.Get(self.tips_rect.gameObject).onDown = function ()
        GameTipsPrefab.ShowDesc("3万鱼币+太阳*6+千元赛门票*1", UnityEngine.Input.mousePosition)
    end
