...
M.key = "act_044_ydlw"
Act_044_YDLWManager.config = GameButtonManager.ExtLoadLua(M.key,"act_044_ydlw_config")
GameButtonManager.ExtLoadLua(M.key,"Act_044_YDLWItemBase")
GameButtonManager.ExtLoadLua(M.key,"Act_044_YDLWPanel")
...
function M.GotoUI(parm)
    if parm.goto_scene_parm == "panel" then
        if M.CheckIsShow() then
            return Act_044_YDLWPanel.Create(parm.parent,parm.backcall)
        end 
    else
