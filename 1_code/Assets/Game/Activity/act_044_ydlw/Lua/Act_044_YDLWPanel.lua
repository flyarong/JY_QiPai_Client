...
Act_044_YDLWPanel = basefunc.class()
local C = Act_044_YDLWPanel
C.name = "Act_044_YDLWPanel"
local M = Act_044_YDLWManager
C.instance = nil

local help_info1 = {
    "1.活动时间：2020年12月29日7:30~2021年1月4日23:59:59",
    "2.活动期间街机捕鱼小游戏中可获得饺子道具",
...
function C:CreateItemPrefab()
	...
	for i=1,#self.cur_data do
		local pre = Act_044_YDLWItemBase.Create(self.Content.transform,self.cur_data[i])
		if pre then
