...
Act_065_ZNJNKJYFLEnterPrefab = basefunc.class()
local C = Act_065_ZNJNKJYFLEnterPrefab
...
function C:MyRefresh()
	...
	if Act_065_ZNJNKManager.getIsBuy() then 
		if not Act_065_ZNJNKManager.getIsLottery() then 
...
function C:OnEnterClick()
	GameManager.GotoUI({gotoui = Act_065_ZNJNKManager.key, goto_scene_parm="panel"})
end
