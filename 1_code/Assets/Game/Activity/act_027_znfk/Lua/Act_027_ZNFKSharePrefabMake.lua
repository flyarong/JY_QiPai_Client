-- 创建时间:2020-08-13
-- Panel:Act_027_ZNFKSharePrefabMake
--[[
 *      ┌─┐       ┌─┐
 *   ┌──┘ ┴───────┘ ┴──┐
 *   │                 │
...
Act_027_ZNFKSharePrefabMake = basefunc.class()
local C = Act_027_ZNFKSharePrefabMake
C.name = "Act_027_ZNFKSharePrefabMake"
...
function C:ctor()
	...
	local obj = newObject("ZNQ_ShareImage", parent)
...
function C:InitUI()
	local data = Act_027_ZNFKManager.GetData()
