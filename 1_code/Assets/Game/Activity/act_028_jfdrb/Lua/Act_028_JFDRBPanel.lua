...
Act_028_JFDRBPanel = basefunc.class()
local C = Act_028_JFDRBPanel
C.name = "Act_028_JFDRBPanel"
local M = Act_028_JFDRBManager
local HGList={
	[1] ="localpop_icon_1",
	[2] ="localpop_icon_2",
	[3] ="localpop_icon_3",
...
local curr_index = 1
local DESCRIBE_TEXT = {
	[1] = "1.活动时间：9月8日7:30-9月14日23:59:59",
	[2] = "2.完成《我要纪念币》活动中的任务获得积分参与排行榜",
	[3] = "3.获得积分总数≥2000才能参与排行榜",
	[4] = "4.获得积分数量越多排名越靠前，积分数量相同时，上榜时间越早排名越靠前",
		...
		for i = 1, #data.rank_data do
			...
			if data.rank_data[i].rank < 4 then
				...
				self.I1_goto_zjf_btn.onClick:AddListener(function ()
					--跳转到"我要赚积分"界面
					ActivityYearPanel_2.instance:SetSelectByName("我要纪念币")
