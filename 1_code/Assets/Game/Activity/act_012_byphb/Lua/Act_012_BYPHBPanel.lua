...
Act_012_BYPHBPanel = basefunc.class()
local C = Act_012_BYPHBPanel
C.name = "Act_012_BYPHBPanel"
...
local base_txt = {
	[1] = {"击杀接吻鱼记录累计赢金，参与排行榜","倍数越高，上榜的机会越大"},
	[2] = {"击杀接吻鱼记录击杀倍数，参与排行榜","倍数相同时，炮倍越高越排在前面！"}
}
local curr_index = 1
local DESCRIBE_TEXT = {
	[1] = "1.活动时间：5月19日7:30-5月25日23:59:59",
	[2] = "2.活动期间复古街机捕鱼中会出现接吻鱼，击杀接吻鱼可以参与排行榜",
	[3] = "3.排行榜中数据都相同时，上榜时间越早排名越靠前",
