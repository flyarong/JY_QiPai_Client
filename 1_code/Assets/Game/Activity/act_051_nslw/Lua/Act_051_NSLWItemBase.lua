...
Act_051_NSLWItemBase = basefunc.class()
local C = Act_051_NSLWItemBase
C.name = "Act_051_NSLWItemBase"
...
function C:ViewTipObj()
	...
	LTTipsPrefab.Show2(self.transform,self.data.tips_desc,self.data.tips_tit)
end
