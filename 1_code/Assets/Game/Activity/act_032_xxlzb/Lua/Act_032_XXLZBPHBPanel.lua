...
Act_032_XXLZBPHBPanel = basefunc.class()
local C = Act_032_XXLZBPHBPanel
C.name = "Act_032_XXLZBPHBPanel"
local M = Act_032_XXLZBManager
local HGList={
	[1] ="localpop_icon_1",
	[2] ="localpop_icon_2",
	[3] ="localpop_icon_3",
...
function C:MakeLister()
	...
	self.lister["act_032_base_info_get"] = basefunc.handler(self,self.on_act_032_base_info_get)
...
function C:on_act_032_base_info_get()
	self:onMyInfoGet()
end
