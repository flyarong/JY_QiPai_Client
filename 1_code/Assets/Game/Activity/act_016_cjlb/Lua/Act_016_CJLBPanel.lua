...
Act_016_CJLBPanel = basefunc.class()
local C = Act_016_CJLBPanel
C.name = "Act_016_CJLBPanel"
...
function C:CreateItemPrefab()
	...
	for i=1,#tab do
		local pre = Act_016_CJLBItemBase.Create(self.Content.transform,self.index,tab[i])
