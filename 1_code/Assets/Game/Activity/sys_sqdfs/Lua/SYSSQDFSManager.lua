-- 创建时间:2019-05-29
-- Panel:SYSSQDFSManager
local basefunc = require "Game/Common/basefunc"

SYSSQDFSManager = basefunc.class()
local M = SYSSQDFSManager
M.key = "sys_sqdfs"
M.lottery_type = "19_october_lottery"--开奖唯一表示
GameButtonManager.ExtLoadLua(M.key, "SYSSQDFSEnterPrefab")
GameButtonManager.ExtLoadLua(M.key, "SummerActivityPanel")
GameButtonManager.ExtLoadLua(M.key, "SummerJFRankPanel")
GameButtonManager.ExtLoadLua(M.key, "ShopSummerPanel")
