...
ShopSummerPanel = basefunc.class()
local C = ShopSummerPanel
C.name = "ShopSummerPanel"
...
function C:ctor(parent, backcall)
	...
	self.BackButton = tran:Find("CloseButton"):GetComponent("Button")
    self.BackButton.onClick:AddListener(function ()
        ExtendSoundManager.PlaySound(audio_config.game.com_but_cancel.audio_name)
        self:OnBackClick()
    end)

	self.ShopButton = tran:Find("Button"):GetComponent("Button")
    self.ShopButton.onClick:AddListener(function ()
        ExtendSoundManager.PlaySound(audio_config.game.com_but_cancel.audio_name)
        self:OnShopClick()
	end)
	self.TimeText = tran:Find("Button/Text"):GetComponent("Text")
