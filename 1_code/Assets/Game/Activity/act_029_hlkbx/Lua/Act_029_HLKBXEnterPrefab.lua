...
Act_029_HLKBXEnterPrefab = basefunc.class()
local C = Act_029_HLKBXEnterPrefab
C.name = "Act_029_HLKBXEnterPrefab"
...
function C:ctor(parent)
	...
	local obj = newObject("Act_029_HLKBXEnterPrefab", parent)
