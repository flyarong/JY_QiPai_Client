-- 创建时间:2020-02-19
-- Panel:FishingActCaijinBoxPrefab
--[[
 *      ┌─┐       ┌─┐
 *   ┌──┘ ┴───────┘ ┴──┐
 *   │                 │
...
FishingActCaijinBoxPrefab = basefunc.class()
local C = FishingActCaijinBoxPrefab
C.name = "FishingActCaijinBoxPrefab"
...
function C:ctor(panelSelf, parent, index)
	...
	self.index = index
	local obj = newObject("fish_act_caijin_box_prefab", parent)
...
function C:showFlash(show)
	self.glow_01.gameObject:SetActive(show)
end