 ...
 *               代码无BUG!
 ...
 Act_042_YGSJBPanel = basefunc.class()
 local C = Act_042_YGSJBPanel
 C.name = "Act_042_YGSJBPanel"
 ...
 function C:MakeLister()
	 self.lister = {}
	 self.lister["act_042_ygsjb_rank_base_info_get"] = basefunc.handler(self, self.on_act_042_ygsjb_rank_base_info_get)
	 self.lister["act_042_ygsjb_rank_info_get"] = basefunc.handler(self, self.on_act_042_ygsjb_rank_info_get)
 ...
 function C:InitRankUser()
	 ...
	 if user_dataUI.ranking_num and user_dataUI.ranking_num <= 3 and user_dataUI.ranking_num ~= -1 then
 ...
 function C:on_act_042_ygsjb_rank_info_get(_, data)
	self:InitRanklis()
 end
 function C:on_act_042_ygsjb_rank_base_info_get(_, data)
	self:InitRankUser()
 end
