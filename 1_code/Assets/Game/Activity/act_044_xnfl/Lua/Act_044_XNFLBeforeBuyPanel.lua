-- 创建时间:2020-05-12
-- Panel:Act_044_XNFLBeforeBuyPanel
--[[
*      ┌─┐       ┌─┐
*   ┌──┘ ┴───────┘ ┴──┐
*   │                 │
...
Act_044_XNFLBeforeBuyPanel = basefunc.class()
local C = Act_044_XNFLBeforeBuyPanel
C.name = "Act_044_XNFLBeforeBuyPanel"
...
function C:MakeLister()
	...
	self.lister["model_xnfl_qfxl_num_change_msg"] = basefunc.handler(self,self.on_model_xnfl_qfxl_num_change_msg)
end
...
function C:InitUI()
	...
	self:on_model_xnfl_qfxl_num_change_msg()
end
...
function C:OnBuyClick()
	...
	dump(M.shopid2, "M.shopid2")
	dump(M.shopid1, "M.shopid1")
