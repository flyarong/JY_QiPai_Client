-- 创建时间:2020-05-20
-- Panel:Act_044_XNFLEnterPrefab_InFLPanel
--[[
*      ┌─┐       ┌─┐
*   ┌──┘ ┴───────┘ ┴──┐
*   │                 │
...
Act_044_XNFLEnterPrefab_InFLPanel = basefunc.class()
local C = Act_044_XNFLEnterPrefab_InFLPanel
C.name = "Act_044_XNFLEnterPrefab_InFLPanel"
...
function C:on_model_xnfl_data_change_msg()
	self.time_txt.text = "(还剩下"..Act_044_XNFLManager.GetTotalRemainNum().."天可领)"
