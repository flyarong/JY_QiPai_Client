...
Act_051_NSSHZPanel = basefunc.class()
local C = Act_051_NSSHZPanel
C.name = "Act_051_NSSHZPanel"
...
function C:MakeLister()
	self.lister = {}
	self.lister["act_051_base_info_get"] = basefunc.handler(self,self.on_act_051_base_info_get)
...
function C:on_act_051_base_info_get()
	self:onMyInfoGet()
end
