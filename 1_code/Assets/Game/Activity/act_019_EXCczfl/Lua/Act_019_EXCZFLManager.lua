-- 创建时间:2020-06-22
-- Act_019_EXCZFLManager 管理器

local basefunc = require "Game/Common/basefunc"
Act_019_EXCZFLManager = {}
local M = Act_019_EXCZFLManager
M.key = "act_019_EXCczfl"

local this
local lister

local task_ids = {
    [1] = {21381,21382,21383,21384,},
    [2] = {21376,21377,21378,21379,21380}
}
local year_ids = {
    96,97
}
local permission = {
    "actp_own_task_p_xiaoxiaole_v1_recharge",
    "actp_own_task_p_xiaoxiaole_v4_recharge",
}
