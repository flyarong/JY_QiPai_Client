...
Act_051_SWITCHManager = {}
local M = Act_051_SWITCHManager
M.key = "act_051_switch"
M.base_config = {
    [1] = {gotoui = "act_051_nslw"},
    [2] = {gotoui = "act_051_nsshz"},
    --[3] = {gotoui = "act_033_bzlb"},
}

GameButtonManager.ExtLoadLua(M.key,"Act_051_SWITCHPanel")
GameButtonManager.ExtLoadLua(M.key,"Act_051_SWITCHEnterPrefab")
...
function M.GotoUI(parm)
    if parm.goto_scene_parm == "panel" then
        return Act_051_SWITCHPanel.Create(parm.parent,parm.backcall)
    end 
    if parm.goto_scene_parm == "enter" then
        return Act_051_SWITCHEnterPrefab.Create(parm.parent)
    end 
