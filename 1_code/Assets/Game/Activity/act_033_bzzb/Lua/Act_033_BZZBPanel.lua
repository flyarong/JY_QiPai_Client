...
Act_033_BZZBPanel = basefunc.class()
local C = Act_033_BZZBPanel
C.name = "Act_033_BZZBPanel"
local M = Act_033_BZZBManager
local HGList={
	[1] ="localpop_icon_1",
	[2] ="localpop_icon_2",
	[3] ="localpop_icon_3",
...
local curr_index = 1
local DESCRIBE_TEXT = {
	"1.活动时间：10月13日7:30~10月19日23:59:59",
	"2.活动结束后，所有的道具将被全部清除，请及时兑换",
	"3.购买“宝藏礼包”后兑换时可获得额外积分奖励",
	"4.积分可参与“宝藏蟹争霸”排行榜活动，活动结束后排行榜奖励通过邮件发放",
}
...
function C:MakeLister()
	self.lister = {}
	self.lister["act_033_base_info_get"] = basefunc.handler(self,self.on_act_033_base_info_get)
...
function C:on_act_033_base_info_get()
	self:onMyInfoGet()
end
