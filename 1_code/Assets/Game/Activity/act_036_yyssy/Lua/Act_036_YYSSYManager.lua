-- 创建时间:2020-10-19
-- Act_036_YYSSYManager 管理器

local basefunc = require "Game/Common/basefunc"
Act_036_YYSSYManager = {}
local M = Act_036_YYSSYManager
M.key = "act_036_yyssy"
GameButtonManager.ExtLoadLua(M.key, "Act_036_YYSSYPanel") 
...
function M.GotoUI(parm)
    if parm.goto_scene_parm == "panel" then
        return Act_036_YYSSYPanel.Create(parm.parent)
    end
