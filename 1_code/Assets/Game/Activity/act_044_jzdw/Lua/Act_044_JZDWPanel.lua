 ...
 *               代码无BUG!
 ...
 Act_044_JZDWPanel = basefunc.class()
 local C = Act_044_JZDWPanel
 C.name = "Act_044_JZDWPanel"
 ...
 function C:MakeLister()
	 self.lister = {}
	 self.lister["act_044_jzdw_rank_base_info_get"] = basefunc.handler(self, self.on_act_044_jzdw_rank_base_info_get)
	 self.lister["act_044_jzdw_rank_info_get"] = basefunc.handler(self, self.on_act_044_jzdw_rank_info_get)
 ...
 function C:on_act_044_jzdw_rank_info_get(_, data)
	self:InitRanklis()
 end
 function C:on_act_044_jzdw_rank_base_info_get(_, data)
	self:InitRankUser()
 end
