...
SYSVip3UpPanel = basefunc.class()
local C = SYSVip3UpPanel
C.name = "SYSVip3UpPanel"
...
function C.ShowDesc(  )
	GameTipsPrefab.ShowDesc("1万鱼币+太阳*2+千元赛门票*1", UnityEngine.Input.mousePosition)
end
