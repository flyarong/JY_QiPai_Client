 ...
 *               代码无BUG!
 ...
 Act_040_XQSJBPanel = basefunc.class()
 local C = Act_040_XQSJBPanel
 C.name = "Act_040_XQSJBPanel"
 ...
 function C:MakeLister()
	 self.lister = {}
	 self.lister["act_040_xqsjb_rank_base_info_get"] = basefunc.handler(self, self.on_act_040_xqsjb_rank_base_info_get)
	 self.lister["act_040_xqsjb_rank_info_get"] = basefunc.handler(self, self.on_act_040_xqsjb_rank_info_get)
 ...
 function C:on_act_040_xqsjb_rank_info_get(_, data)
	self:InitRanklis()
 end
 function C:on_act_040_xqsjb_rank_base_info_get(_, data)
	self:InitRankUser()
 end
