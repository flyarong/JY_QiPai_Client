...
Act_027_ZNQLBEnterPrefab = basefunc.class()
local C = Act_027_ZNQLBEnterPrefab
C.name = "Act_027_ZNQLBEnterPrefab"
...
function C:ctor(parent)
	...
	local obj = newObject("Act_027_ZNQLBEnterPrefab", parent)
...
function C:OnEnterClick()
	local b = GameComGiftT4Panel.Create(nil, nil, M.config[M.level],nil,"Act_027_ZNQLBPanel")
	for i = 1, 3 do
		local ui = {}
