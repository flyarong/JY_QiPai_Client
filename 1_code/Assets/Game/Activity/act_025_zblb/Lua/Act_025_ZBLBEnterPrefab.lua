...
Act_025_ZBLBEnterPrefab = basefunc.class()
local C = Act_025_ZBLBEnterPrefab
C.name = "Act_025_ZBLBEnterPrefab"
...
function C:ctor(parent)
	...
	local obj = newObject("Act_025_ZBLBEnterPrefab", parent)
...
function C:OnEnterClick()
	local b = GameComGiftT4Panel.Create(nil, nil, M.config[M.level],nil,"Act_025_ZBLBPanel")
