...
local user_data = {}
local rank_data = {}
local _rank_type = "axfl_045_xxlbd_rank"

-- 是否有活动
function M.IsActive()
    -- 活动的开始与结束时间
    local e_time = 1610380799
    local s_time = 1609803000
...
function M.on_year_btn_created(data)
    ...
    if  data and data.enterSelf then
        ...
        notice_prefab=newObject("Act_045_XXLBDPrefab",btn_gameObject.transform)
