...
Act_033_BZLBEnterPrefab = basefunc.class()
local C = Act_033_BZLBEnterPrefab
C.name = "Act_033_BZLBEnterPrefab"
...
function C:ctor(parent)
	...
	local obj = newObject("Act_033_BZLBEnterPrefab", parent)
...
function C:OnEnterClick()
	local b = GameComGiftT4Panel.Create(nil, nil, M.config[M.level],nil,"Act_033_BZLBPanel")
	for i = 1,3 do
		local ui = {}
