...
function M.GotoUI(parm)
    dump(parm,"<color=white>国庆福利</color>")
    if parm.goto_scene_parm == "share_link" then
        return GameManager.GotoUI({gotoui = "share_link",goto_scene_parm = "url_gzgfgzh"})
	end
