-- 创建时间:2020-05-12
-- Panel:Act_013_DLFLAfterBuyPanel
--[[
 *      ┌─┐       ┌─┐
 *   ┌──┘ ┴───────┘ ┴──┐
 *   │                 │
...
Act_013_DLFLAfterBuyPanel = basefunc.class()
local C = Act_013_DLFLAfterBuyPanel
C.name = "Act_013_DLFLAfterBuyPanel"
...
function C:InitUI()
	...
	self:on_model_dlfl_data_change_msg()
end
