...
Act_020_XGSJBPanel = basefunc.class()
local C = Act_020_XGSJBPanel
C.name = "Act_020_XGSJBPanel"
...
local curr_index = 1
local DESCRIBE_TEXT = {
	[1] = "1.活动时间：7月14日7:30-7月21日06:30:00",
	[2] = "2.活动期间街机捕鱼游戏中会出现西瓜BOSS鱼，击杀可参与排行榜",
	[3] = "3.获得西瓜道具越多排名越靠前，西瓜数据相同时，上榜时间越早排名越靠前",
	[4] = "4.使用炮倍越大上榜机会越大",
