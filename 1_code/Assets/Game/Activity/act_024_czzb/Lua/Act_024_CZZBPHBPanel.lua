...
Act_024_CZZBPHBPanel = basefunc.class()
local C = Act_024_CZZBPHBPanel
C.name = "Act_024_CZZBPHBPanel"
...
function C:MakeLister()
	self.lister = {}
	self.lister["act_024_base_info_get"] = basefunc.handler(self,self.on_act_024_base_info_get)
...
function C:on_act_024_base_info_get()
	self:onMyInfoGet()
end
