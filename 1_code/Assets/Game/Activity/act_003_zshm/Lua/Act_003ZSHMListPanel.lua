...
Act_003ZSHMListPanel = basefunc.class()
local C = Act_003ZSHMListPanel
C.name = "Act_003ZSHMListPanel"
local Page_Index  =  1
function C.Create()
	return C.New()
end
...
function C:ctor()
	...
	self:AddMsgListener()
	self:InitUI()
	Network.SendRequest("common_lottery_query_award_logs",{page_index = Page_Index,lottery_type = "box_exchange_14"})
end
