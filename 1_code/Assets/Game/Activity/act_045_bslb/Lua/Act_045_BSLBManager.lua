-- 创建时间:2020-11-05
-- Act_045_BSLBManager 管理器

local basefunc = require "Game/Common/basefunc"
Act_045_BSLBManager = {}
local M = Act_045_BSLBManager
M.key = "act_045_bslb"
GameButtonManager.ExtLoadLua(M.key, "Act_045_BSLBEnterPrefab")
M.config = GameButtonManager.ExtLoadLua(M.key, "act_045_bslb_config").config
...
local permiss = {
    "actp_buy_gift_bag_class_multiple_gift01",
    "actp_buy_gift_bag_class_multiple_gift02",
    "actp_buy_gift_bag_class_multiple_gift03",
    "actp_buy_gift_bag_class_multiple_gift04",
}
...
function M.GotoUI(parm)
    ...
    if parm.goto_scene_parm == "enter" then
        return Act_045_BSLBEnterPrefab.Create(parm.parent, parm.cfg)
    end
end
-- 活动的提示状态
...
--     return Act_045_BSLBEnterPrefab.Create(parm.switchPanel.transform)
-- end
