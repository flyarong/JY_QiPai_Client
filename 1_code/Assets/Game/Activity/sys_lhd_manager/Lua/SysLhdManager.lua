...
SysLhdManager = {}
local M = SysLhdManager
M.key = "sys_lhd_manager"
M.lhd_hall_config = GameButtonManager.ExtLoadLua(M.key, "lhd_hall_config")
GameButtonManager.ExtLoadLua(M.key, "LHDManager")
