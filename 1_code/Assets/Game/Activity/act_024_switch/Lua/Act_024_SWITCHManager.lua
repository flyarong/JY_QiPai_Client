...
Act_024_SWITCHManager = {}
local M = Act_024_SWITCHManager
M.key = "act_024_switch"
M.base_config = {
    [1] = {gotoui = "act_024_bzdh"},
    [2] = {gotoui = "act_024_czzb"},
    [3] = {gotoui = "act_024_bzlb"},
}

GameButtonManager.ExtLoadLua(M.key,"Act_024_SWITCHPanel")
GameButtonManager.ExtLoadLua(M.key,"Act_024_SWITCHEnterPrefab")
...
function M.GotoUI(parm)
    if parm.goto_scene_parm == "panel" then
        return Act_024_SWITCHPanel.Create(parm.parent,parm.backcall)
    end 
    if parm.goto_scene_parm == "enter" then
        return Act_024_SWITCHEnterPrefab.Create(parm.parent)
    end 
