...
Act_018_HLQJDPrefab = basefunc.class()
local C = Act_018_HLQJDPrefab
C.name = "Act_018_HLQJDPrefab"
...
function C:ctor(parent)
	...
	local obj = newObject("Act_018_HLQJDPrefab", parent)
