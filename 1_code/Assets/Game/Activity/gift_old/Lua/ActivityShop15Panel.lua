...
ActivityShop15Panel = basefunc.class()
local M = ActivityShop15Panel

M.name = "ActivityShop15Panel"
...
function M:MakeLister()
	...
	self.lister["finish_gift_shop_shopid_21"] = basefunc.handler(self, self.finish_gift_shop_shopid_21)
end
...
function M:finish_gift_shop_shopid_21()
	self.status = 0
	self:MyRefresh()
end
