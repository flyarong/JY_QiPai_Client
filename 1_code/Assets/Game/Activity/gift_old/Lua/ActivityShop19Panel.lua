...
ActivityShop19Panel = basefunc.class()
local C = ActivityShop19Panel
C.name = "ActivityShop19Panel"
...
function C:MakeLister()
	...
	self.lister["finish_gift_shop_shopid_39"] = basefunc.handler(self, self.finish_gift_shop_shopid_39)
end
...
function C:finish_gift_shop_shopid_39()
	self.status = 0
	self:MyRefresh()
end
