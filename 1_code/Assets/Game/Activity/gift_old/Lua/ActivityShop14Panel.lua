...
ActivityShop14Panel = basefunc.class()
local M = ActivityShop14Panel

M.name = "ActivityShop14Panel"
...
function M:MakeLister()
	...
	self.lister["finish_gift_shop_shopid_20"] = basefunc.handler(self, self.finish_gift_shop_shopid_20)
end
...
function M:finish_gift_shop_shopid_20()
	self.status = 0
	self:MyRefresh()
end
