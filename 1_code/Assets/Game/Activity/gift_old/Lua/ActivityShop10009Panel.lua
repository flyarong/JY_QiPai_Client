...
ActivityShop10009Panel = basefunc.class()
local C = ActivityShop10009Panel
C.name = "ActivityShop10009Panel"
...
function C:ctor(parent, backcall)
	...
	self.ShopButton = tran:Find("BuyButton"):GetComponent("Image")
	PointerEventListener.Get(self.ShopButton.gameObject).onClick = function()
		ExtendSoundManager.PlaySound(audio_config.game.com_but_cancel.audio_name)
		self:OnShopClick()
	end
