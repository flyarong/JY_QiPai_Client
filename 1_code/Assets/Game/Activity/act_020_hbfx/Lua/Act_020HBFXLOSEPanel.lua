...
Act_020HBFXLOSEPanel = basefunc.class()
local C = Act_020HBFXLOSEPanel
C.name = "Act_020HBFXLOSEPanel"
	...
	self.cancel_btn.onClick:AddListener(
		function ()
			...
			local callback = function (  )
				basefunc.handler(self.panelSelf, self.panelSelf.OnBackClick)
			end
