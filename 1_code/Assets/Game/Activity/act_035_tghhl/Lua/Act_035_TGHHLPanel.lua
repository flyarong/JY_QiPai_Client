...
Act_035_TGHHLPanel = basefunc.class()
local C = Act_035_TGHHLPanel
C.name = "Act_035_TGHHLPanel"
local M = Act_035_TGHHLManager
--"♠ : 1","♥ : 2","♣ : 3","♦ : 4",46-54
local ex_change = {
	{ex_change_id = 106,need = {{parm = 1,num =2}},award ={{num = "最高1500",_type = "jing_bi"},{num = 30,_type = "jifen"}}},
	{ex_change_id = 107,need = {{parm = 2,num =2}},award ={{num = "最高2000",_type = "jing_bi"},{num = 40,_type = "jifen"}}},
	{ex_change_id = 108,need = {{parm = 3,num =2}},award ={{num = "最高3000",_type = "jing_bi"},{num = 60,_type = "jifen"}}},
	{ex_change_id = 109,need = {{parm = 4,num =25}},award ={{num = "最高8000",_type = "jing_bi"},{num = 100,_type = "jifen"}}},
	{ex_change_id = 110,need = {{parm = 4,num =25},{parm = 3,num =2},{parm = 2,num =2},{parm = 1,num =2}},award ={{num = "最高3",_type = "shop_gold_sum"},{num = 300,_type = "jifen"}}},
}
...
local DESCRIBE_TEXT = {
	[1] = "1.活动时间：10月27日7:30~11月2日23:59:59",
	[2] = "2.积分可参与积分排行榜，最高可领1000福卡",
	[3] = "3.购买万圣礼包后当日兑换积分时可翻倍领取，最多可2倍领取",
	[4] = "4.一键兑换功能会根据糖果组合从多到少自动匹配兑换",
}
...
function C:InitUI()
	self.duihuan_btn.onClick:AddListener(function ()
		ExtendSoundManager.PlaySound(audio_config.game.com_but_confirm.audio_name)
		HintPanel.Create(2,"一键兑换功能会根据糖果组合从多到少自动匹配兑换，是否确认兑换",function ()
			Network.SendRequest("box_all_exchange",{name = "wsj_tghhl"})
		end)
...
function C:RefreshMainUI()
	for i = 1,#self.MainItems do
		...
		Timer.New(function()
			local num = Act_035_WSLBManager.GetBeiShu()
