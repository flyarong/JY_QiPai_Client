-- 创建时间:2020-10-11
-- Panel:WUZIQISYSCSSLEnterPrefab
--[[
 *      ┌─┐       ┌─┐
 *   ┌──┘ ┴───────┘ ┴──┐
 *   │                 │
...
WUZIQISYSCSSLEnterPrefab = basefunc.class()
local C = WUZIQISYSCSSLEnterPrefab
C.name = "WUZIQISYSCSSLEnterPrefab"
