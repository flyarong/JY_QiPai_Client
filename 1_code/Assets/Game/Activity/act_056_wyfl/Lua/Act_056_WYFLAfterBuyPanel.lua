-- 创建时间:2020-05-12
-- Panel:Act_056_WYFLAfterBuyPanel
--[[
*      ┌─┐       ┌─┐
*   ┌──┘ ┴───────┘ ┴──┐
*   │                 │
...
Act_056_WYFLAfterBuyPanel = basefunc.class()
local C = Act_056_WYFLAfterBuyPanel
C.name = "Act_056_WYFLAfterBuyPanel"
...
function C:OnGetClick()
	Network.SendRequest("welfare_activity_receive_award",{act_type = Act_056_WYFLManager.type})
end