...
EliminateSHButtonPrefab = basefunc.class()
local M = EliminateSHButtonPrefab
local ins
M.name = "EliminateSHButtonPrefab"
...
function M:ctor(id, money, parent)
    ...
    self.img.sprite = GetTexture("shxxl_icon_" .. self.icon_id)
