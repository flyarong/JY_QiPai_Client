...
function C:ctor(parent,_type)
	...
	self.gameObject = obj
	self._type = _type
	self.person = _type == "nor_ddz_er" and 2 or 3
	...
	self:AddMsgListener()
	self:InitUI()
	xishu = GameZJFModel.get_ddz_enter_xishu_by_type(_type)
	enter_base = GameZJFModel.get_ddz_enter_base_by_type(_type)
...
function C:SetUI()
	...
	self.fwq2_tge.isOn = not DdzFKModel.IsFZPaY()
end
