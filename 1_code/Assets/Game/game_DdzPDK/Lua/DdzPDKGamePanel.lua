...
function DdzPDKGamePanel:MakeLister()
    ...
    lister["pdkclear_created"] = basefunc.handler(self, self.on_pdkclear_created)
    lister["pdkclear_seecard"] = basefunc.handler(self, self.on_pdkclear_seecard)
...
function DdzPDKGamePanel:on_pdkclear_created()
    self:ChangeBtnNodeView(false)
end

function DdzPDKGamePanel:on_pdkclear_seecard(data)
    self:ChangeBtnNodeView(not data.isShow)
end

function DdzPDKGamePanel:on_fg_close_clearing()
    local m_data = DdzPDKModel.data
    if m_data.model_status ~= DdzPDKModel.Model_Status.wait_table then
        self:ChangeBtnNodeView(true)
    end
...
function DdzPDKGamePanel:ChangeBtnNodeView(isShow)
