...
local FreeUIConfig = require "Game.game_MjXzFK3D.Lua.mjxzfk_freestyle_ui3D"	--ui配置
local FreeAwardConfig = require "Game.game_MjXzFK3D.Lua.mjxzfk_drivingrange_award3D"   --奖励配置
