-- 创建时间:2019-05-17
-- Panel:EliminateXYClearPanel
local basefunc = require "Game/Common/basefunc"
EliminateXYClearPanel = basefunc.class()
local C = EliminateXYClearPanel
C.name = "EliminateXYClearPanel"
local hide
local addmoney
local instance
local delay_time = {
...
function C:view_lottery_end(data)
    local dangci = EliminateXYModel.GetAllResultLevel()
...
function C:ShowClear(data)
    ...
    if data[1] == 2 then
        ExtendSoundManager.PlaySceneBGM(audio_config.sdbgj.bgm_sdbgj_beijing.audio_name)
        self.hidetime = 2
        ExtendSoundManager.PlaySound(audio_config.sdbgj.bgm_sdbgj_jiangli2.audio_name)
    end
    if data[1] == 3 then
        self.hidetime = 8
        self.soundlv3 = nil
        self.soundlv3 =
            ExtendSoundManager.PlaySound(
            audio_config.sdbgj.bgm_sdbgj_jiangli3.audio_name,
            1,
            function()
                self.soundlv3 = nil
            end
    ...
    if data[1] == 4 then
        ...
        self.soundlv4 =
            ExtendSoundManager.PlaySound(
            audio_config.sdbgj.bgm_sdbgj_jiangli4.audio_name,
            1,
            function()
                self.soundlv4 = nil
            end
    ...
    local ani
    if data[1] == 1 then
        ani = "EliminateXYClearPanel_jiesuan1"
    ...
    local is_auto = EliminateXYModel.GetAuto()
