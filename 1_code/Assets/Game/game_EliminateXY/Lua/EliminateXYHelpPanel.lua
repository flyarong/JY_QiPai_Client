...
EliminateXYHelpPanel = basefunc.class()
local C = EliminateXYHelpPanel
C.name = "EliminateXYHelpPanel"
...
function C:InitUI()
	...
	local rate_map = eliminate_xy_algorithm.rate_map
	...
	for xc_count = 3,8 do
		...
		for xc_id = 1,5 do
			ui_table["id" .. xc_id .. "_txt"].text = eliminate_xy_algorithm.get_rate(xc_id,xc_count) .. "倍"
		end
	end
