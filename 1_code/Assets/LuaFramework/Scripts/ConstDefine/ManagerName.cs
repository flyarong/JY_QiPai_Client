...
namespace LuaFramework {
    public class ManagerName {
        ...
        public const string SDK = "SDKManager";
        public const string WEB = "WebManager";
		public const string GestureManager = "GestureManager";
		public const string EventManager = "EventManager";
        public const string InAppPurchasing = "InAppPurchasing";
    }
}